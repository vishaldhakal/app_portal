...
export default function Developers() {
  ...
  const handleUpdateDeveloper = (e) => {
    ...
    axios
      .put(
        `https://portal.condomonk.ca/api/developers/${developerdata.id}/`,
        updatedeveloperdata,
        {
          headers: {
            "Content-Type": "multipart/form-data",
  ...
  function deleteDeveloper(id) {
    axios
      .delete(`https://portal.condomonk.ca/api/developers/${id}/`)
      .then((res) => {
        console.log(res);
        setRefetch(!refetch);
      })
  ...
  const handleEdit = (e, id) => {
    e.preventDefault();
    axios
      .get(`https://portal.condomonk.ca/api/developers/${id}/`)
      .then((res) => {

...
export default function Cities() {
  ...
  const handleCreateCity = (e) => {
    ...
    axios
      .post("https://portal.condomonk.ca/api/city/", citydata)
      .then((res) => {
        setRefetcch(!refetch);
        setCityData(stat);
        setModalCity(false);
  ...
  const handleUpdateCity = (e) => {
    ...
    axios
      .put(
        `https://portal.condomonk.ca/api/city/${citydata.id}/`,
        updatecitydata
      )
      .then((res) => {
        setModalCity(false);
  ...
  function deleteEvent(id) {
    axios
      .delete(`https://portal.condomonk.ca/api/city/${id}/`)
      .then((res) => {
        console.log(res);
        setRefetcch(!refetch);
      })
  ...
  const handleEdit = (e, id) => {
    e.preventDefault();
    axios
      .get(`https://portal.condomonk.ca/api/city/${id}/`)
      .then((res) => {
